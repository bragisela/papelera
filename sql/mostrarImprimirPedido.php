<?php
  ...
  $mostrarPedidoImprimirDatos = $conexiones->query("SELECT prov.nombre, prov.condicionIVA, prov.cuit, prov.domicilio , c.nrocomprobante, c.fecha from comprobantes as c
