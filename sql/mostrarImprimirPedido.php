<?php
  ...
  $mostrarPedidoImprimirCalculos = $conexiones->query("SELECT c.justificante,c.idComprobante, c.fecha, p.codproducto, p.descripcion, i.cant, pre.importe, pre.porcUtil from comprobantes as c
