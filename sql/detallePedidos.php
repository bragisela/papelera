...
$detallePedidos = $conexiones->query("SELECT c.totalcomprado,c.justificante,i.idItems, i.cant, p.descripcion, p.codProducto, pre.importe, pre.porcUtil from comprobantes as c
